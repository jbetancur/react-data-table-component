...
test('<ProgressWrapper component /> should render correctly when a component is passed that is a string', () => {
...
test('<ProgressWrapper component /> should render correctly when a component is passed that is a react component', () => {
...
test('<ProgressWrapper centered /> should render correctly when a component is passed that is a react component', () => {
