...
const THEMES = ['default', 'dark', 'material', 'material-dark', 'quartz', 'quartz-dark', 'alpine', 'alpine-dark', 'midnight'] as const;
...
const data = [
  ...
  { id: 7, name: 'Casey Morgan',  role: 'Backend Engineer',  department: 'Engineering', salary: 138000, status: 'Active' },
    ...
    <div className="rounded-xl border border-gray-200 overflow-hidden shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-4 px-4 py-3 bg-gray-50 border-b border-gray-200 text-sm">
        <div className="flex items-center gap-2">
          <label className="text-gray-500 font-medium">Theme</label>
          <select
            value={theme}
