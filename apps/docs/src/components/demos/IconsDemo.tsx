...
const data: Employee[] = [
	{
		...
		bio: 'Leads the platform team with a focus on reliability.',
	},
	{
		id: 2,
		name: 'Marcus Webb',
		...
		department: 'Product',
		bio: 'Drives roadmap strategy across three product lines.',
	},
	{
		id: 3,
		name: 'Priya Kapoor',
		...
		department: 'Design',
		bio: 'Owns the design system and mobile experience.',
	},
	{
		id: 4,
		name: 'Jordan Ellis',
		...
		bio: 'Builds ML pipelines for churn and revenue forecasting.',
	},
	{
		id: 5,
		name: 'Sam Rivera',
		role: 'SRE',
		department: 'Engineering',
		bio: 'Manages uptime, incidents, and deployment pipelines.',
	},
	{
		id: 6,
		name: 'Taylor Brooks',
		role: 'Sales Lead',
		department: 'Sales',
		bio: 'Responsible for enterprise accounts in EMEA.',
	},
	{
		id: 7,
		name: 'Casey Morgan',
		role: 'HR Manager',
		department: 'HR',
		bio: 'Owns hiring, onboarding, and culture initiatives.',
	},
	{
		id: 8,
		name: 'Alex Kim',
		role: 'Staff Engineer',
		department: 'Engineering',
		bio: 'Architect for the data platform and internal APIs.',
	},
	{
		id: 9,
		name: 'Morgan Lee',
		role: 'Designer',
		department: 'Design',
		bio: 'Works on user research and prototype validation.',
	},
	{
		id: 10,
		name: 'Drew Park',
		role: 'Analyst',
		department: 'Analytics',
		bio: 'Produces dashboards and weekly business metrics.',
	},
	{
		id: 11,
		name: 'Riley Nguyen',
		role: 'Frontend Eng',
		department: 'Engineering',
		bio: 'Builds customer-facing product surfaces in React.',
	},
	{
		id: 12,
		name: 'Jamie Okafor',
		role: 'Backend Eng',
		department: 'Engineering',
		bio: 'Maintains the microservices and event bus.',
	},
];
		...
		<div className="space-y-3">
			<div className="flex flex-wrap items-center gap-2">
				{modes.map(m => (
					<button
						key={m.key}
						className={`${btnBase} ${mode === m.key ? btnOn : btnOff}`}
