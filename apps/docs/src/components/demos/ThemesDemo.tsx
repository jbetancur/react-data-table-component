...
interface Row { id: number; name: string; role: string; salary: number }
...
const columns: TableColumn<Row>[] = [
  ...
  { name: 'Salary', selector: r => r.salary, format: r => `$${r.salary.toLocaleString()}`, right: true, sortable: true },
];
...
createTheme('ocean', {
  colors: {
    ...
    button: { default: '#38bdf8', hover: '#7dd3fc', disabled: '#075985' },
