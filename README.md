...
| paginationServerOptions | object | no | `{ persistSelectedOnPageChange: false, persistSelectedOnSort: false }` | used to make selected rows persist on page change and sort when using server side pagination |
