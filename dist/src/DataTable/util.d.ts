...
export declare function getProperty<T>(row: T, selector: Selector<T> | string | undefined | null | unknown, format: Format<T> | undefined | null, rowIndex: number): any;
export declare function insertItem<T>(array: T[], item: T, index?: number): T[];
export declare function removeItem<T>(array: T[], item: T, keyField?: string): T[];
